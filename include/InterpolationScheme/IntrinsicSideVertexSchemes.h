 ...
 */
template <typename Scalar>
Scalar intrinsicWojtanSideVertexInterpolation(const std::vector<Scalar>& vertVal, const std::vector<Scalar>& edgeDeriv, const std::vector<Eigen::Vector3d>& tri, const Eigen::Vector3d& bary)
{
    double sum = 0;
    for(int i = 0; i < 3; i++)
