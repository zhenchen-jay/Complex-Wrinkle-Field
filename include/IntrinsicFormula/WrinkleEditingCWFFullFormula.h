...
namespace IntrinsicFormula
{
	...
	class WrinkleEditingCWFFullFormula : public WrinkleEditingModel
	{
	public:
        WrinkleEditingCWFFullFormula(const Eigen::MatrixXd& pos, const MeshConnectivity& mesh, const std::vector<VertexOpInfo>& vertexOpts, const Eigen::VectorXi& faceFlag, int quadOrd, double spatialAmpRatio, double spatialEdgeRatio, double spatialKnoppelRatio, int effectivedistFactor) :
