...
{
    class WrinkleEditingHalfEdgeModel
    {
    public:
        WrinkleEditingHalfEdgeModel()
        {}

        WrinkleEditingHalfEdgeModel(const Eigen::MatrixXd& pos, const MeshConnectivity& mesh, const std::vector<int>& selectedVids,  const Eigen::VectorXi& faceFlag, int quadOrd, double spatialRatio = 1);
