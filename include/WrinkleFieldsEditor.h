...
namespace WrinkleFieldsEditor
{
     ...
     void edgeBasedWrinkleEdition(const Eigen::MatrixXd& pos, const MeshConnectivity& mesh, const Eigen::VectorXd& amp, const Eigen::VectorXd& omega, const std::vector<VertexOpInfo>& vertInfo, Eigen::VectorXd& ampNew, Eigen::VectorXd& omegaNew);

     void halfEdgeBasedWrinkleEdition(const Eigen::MatrixXd& pos, const MeshConnectivity& mesh, const Eigen::VectorXd& amp, const Eigen::MatrixXd& omega, const std::vector<VertexOpInfo>& vertInfo, Eigen::VectorXd& ampNew, Eigen::MatrixXd& omegaNew);
